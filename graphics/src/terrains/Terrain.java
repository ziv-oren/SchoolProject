...
public class Terrain {
	...
	private static final float SIZE = 1600; //terrain size
	...
	public Terrain(int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack, TerrainTexture blendMap, String heightMap){ //constructor
